...
function resultFor(value) {
  ...
  if (value >= 7) return { level: "Agent-ready", title: "База для агентной работы уже есть", copy: "Вы понимаете основные компоненты современной AI-системы. Закройте отмеченные пробелы и закрепите знания на небольшом рабочем проекте." };
